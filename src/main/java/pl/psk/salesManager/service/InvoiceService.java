...
public class InvoiceService {
    ...
    private void addInvoiceData(Document document, Order order) {
        ...
        table.addCell(createBorderlessHeaderCell("Sold by: ").setBorderRight(new DoubleBorder(Color.DARK_GRAY, 1)));
        table.addCell(createBorderlessHeaderCell("Sold to:").setBorderRight(new DoubleBorder(Color.DARK_GRAY, 1)));
        ...
        table.addCell(createBorderlessCell("Payment method"));
